...
const Terms = () => {
  return (
    <div className='container terms pt-2'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to TEZLA Energy Pvt. Ltd, Ananthapura
            Industrial Area, Kannur, Kubmala, Kerala-671321.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to www.tezla.in, accessible from{" "}
            <a
              href="https://www.tezla.in/"
      ...
      <ul>
        <li>By email: texlacare@tezlabattries.com</li>
      </ul>
    </div>
  );
}
